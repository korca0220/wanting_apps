...
extension WdsThemeAccess on BuildContext {
  WdsColorScheme get wdsColors =>
      Theme.of(this).extension<WdsColorScheme>()!;
  ...
  WdsRadiusTheme get wdsRadius =>
      Theme.of(this).extension<WdsRadiusTheme>()!;

  WdsShadowsTheme get wdsShadows =>
      Theme.of(this).extension<WdsShadowsTheme>()!;

  WdsMotionTheme get wdsMotion =>
      Theme.of(this).extension<WdsMotionTheme>()!;
}
