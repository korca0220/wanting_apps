...
class WdsTypographyTokens {
  ...
  static final TextStyle display1 = _v(size: 56, height: 72, letterEm: -0.0319);
  static final TextStyle display2 = _v(size: 40, height: 52, letterEm: -0.0282);
  static final TextStyle display3 = _v(size: 36, height: 48, letterEm: -0.027);
  ...
  static final TextStyle headline1 = _v(size: 18, height: 26, letterEm: -0.002);
  ...
  static final TextStyle body1Reading = _v(
    size: 16,
    height: 26,
    letterEm: 0.0057,
  );
  static final TextStyle body2 = _v(size: 15, height: 22, letterEm: 0.0096);
  static final TextStyle body2Reading = _v(
    size: 15,
    height: 24,
    letterEm: 0.0096,
  );
  ...
  static final TextStyle label1Reading = _v(
    size: 14,
    height: 22,
    letterEm: 0.0145,
  );
