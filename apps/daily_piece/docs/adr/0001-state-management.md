...
- Provider 위치는 [ADR 0006](0006-clean-architecture-layout.md) 컨벤션을 따른다 — 피처 provider는 `lib/features/<feature>/presentation/providers/`, 공유 repository provider는 구현체 옆 `lib/core/data/repositories/`.
