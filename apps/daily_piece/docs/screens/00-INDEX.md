...
| 08 Create Account | **SignUpPage**           | [`features/auth/presentation/pages/sign_up_page.dart`](../../lib/features/auth/presentation/pages/sign_up_page.dart)                           | Name(Optional) / Email / Password(≥8) / Confirm Password + **Sign in with Google** + ToS 풋터                      |
| 09 Welcome Back   | **SignInPage**           | [`features/auth/presentation/pages/sign_in_page.dart`](../../lib/features/auth/presentation/pages/sign_in_page.dart)                           | Email / Password + Forgot password? → /reset-password + **Sign in with Google** + ToS 풋터                         |
