...
class EditPieceForm extends ConsumerStatefulWidget {
  const EditPieceForm({super.key, required this.piece});

  final Piece piece;

  @override
  ConsumerState<EditPieceForm> createState() => _EditPieceFormState();
}

class _EditPieceFormState extends ConsumerState<EditPieceForm> {
